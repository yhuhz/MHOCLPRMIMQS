    ...
    <div class="card-box q-mx-md q-mb-xl">
      <div class="row">
        ...
        <div class="col-3 q-pa-md first-col">
          ...
          <div>
            <!-- Address -->
            <p class="text-center text-primary address-style">
          ...
          <div class="findings q-my-lg">
            ...
            <div class="q-ma-md">
              ...
              <template v-slot:prepend>
                <q-icon name="eva-edit-outline" color="primary" class="cursor-pointer" />
              </template>

              <template v-slot:append>
                <q-icon name="eva-trash-2-outline" color="primary" class="cursor-pointer" />
              </template>
              </q-input>
            </div>
          </div>
