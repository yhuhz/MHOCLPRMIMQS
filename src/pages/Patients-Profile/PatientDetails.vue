import { PatientRecords } from 'src/composables/Patients'; import PatientDetails
from '../script/Patients-Profile/PatientDetails.js'; import PatientDetails from
'../script/Patients-Profile/PatientDetails.js';
        ...
        <div class="col-3 q-pa-md first-col" style="width: 20vw; height: 50%">
          ...
          <div class="row q-my-md">
            <div class="col" v-if="selectedDepartment != null">
              <q-table :columns="columns" :rows="PatientRecords" dense />
            </div>
          </div>
        </div>
