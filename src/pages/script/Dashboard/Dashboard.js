...
import { DashboardData, GetDashboardData } from 'src/composables/Dashboard.js'
import { useQuasar, SessionStorage, Loading } from 'quasar'
import { GetQueueSpecific, QueueSpecific, CallNextPatient } from 'src/composables/Queue'
...
export default {
  setup() {
    ...
    const callInNextPriority = () => {
      Loading.show()
      CallNextPatient({
        current_patient: currentPatient.value !== null ? currentPatient.value.queue_id : null,
