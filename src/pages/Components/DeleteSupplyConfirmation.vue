<template>
  <div class="width-300">
    ...
    <p class="text-dark m-width-250">Do you really want to delete this record?</p>
    <div class="flex justify-around q-mt-md">
      <q-btn @click="closeDialog" label="Cancel" no-caps color="grey-7" class="button-100" />
      <q-btn color="negative" label="Yes" no-caps class="button-100" @click="deleteSupplyRecord" />
    </div>
  </div>
</template>
...
import { DeleteSupply, DeleteSupplyRelease, FindSupplyDetails } from 'src/composables/Supply'
